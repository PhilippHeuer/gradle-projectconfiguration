...
open class DependencyVersion {
    companion object {
        ...
        @JvmStatic var quarkusVersion: String = "2.7.0.Final" // https://mvnrepository.com/artifact/io.quarkus/quarkus-core
        ...
        @JvmStatic var slf4jVersion: String = "1.7.35" // https://mvnrepository.com/artifact/org.slf4j/slf4j-api
