...
open class DependencyVersion {
    companion object {
        ...
        @JvmStatic var junit5Version: String = "5.9.0"
        ...
        @JvmStatic var slf4jVersion: String = "2.0.1"
