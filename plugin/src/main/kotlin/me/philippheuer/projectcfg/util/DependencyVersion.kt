...
open class DependencyVersion {
    companion object {
        ...
        @JvmStatic var kotlinVersion: String = "1.7.21"
        ...
        @JvmStatic var quarkusVersion: String = "2.14.0.Final"
        ...
        @JvmStatic var sentryVersion: String = "6.7.0"
        ...
        @JvmStatic var jandexVersion: String = "3.0.3"
        // renovate: datasource=maven depName=io.micrometer:micrometer-bom
        @JvmStatic var micrometerVersion: String = "1.10.0"
    }
}