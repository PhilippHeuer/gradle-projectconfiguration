...
open class DependencyVersion {
    companion object {
        ...
        @JvmStatic var mockitoVersion: String = "4.5.1" // https://mvnrepository.com/artifact/org.mockito/mockito-core
        @JvmStatic var mockitoKotlinVersion: String = "4.0.0" // https://mvnrepository.com/artifact/org.mockito.kotlin/mockito-kotlin
        @JvmStatic var jacksonVersion: String = "2.13.3" // https://mvnrepository.com/artifact/com.fasterxml.jackson.core/jackson-databind
        @JvmStatic var springBootVersion: String = "2.6.7" // https://mvnrepository.com/artifact/org.springframework.boot/spring-boot-starter
        ...
        @JvmStatic var quarkusVersion: String = "2.9.1.Final" // https://mvnrepository.com/artifact/io.quarkus/quarkus-core
        ...
        @JvmStatic var sentryVersion: String = "5.7.4" // https://mvnrepository.com/artifact/io.sentry/sentry
